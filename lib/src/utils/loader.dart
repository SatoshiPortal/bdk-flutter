...
import 'package:bdk_dart/src/generated/frb_generated.dart';
import 'package:flutter/services.dart' show Uint8List, rootBundle;
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
import 'package:http/http.dart' as http;

const name = "libbdkbridge";

class Dylib {
  static Map<String, dynamic>? _config;
  static String get libName => "unittest.libbdk.${_config!['TAG_VERSION']}";
  ...
  static Future<void> init() async {
    try {
      if (!BdkCore.instance.initialized) {
        await BdkCore.init(externalLibrary: Dylib.getDylib());
      }
    } catch (e) {
